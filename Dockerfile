...
ARG PROJECT_HOME_DIR

RUN set -eux; \
	apk add --no-cache --virtual .build-deps $PHPIZE_DEPS; \
	pecl install xdebug-$XDEBUG_VERSION; \
	docker-php-ext-enable xdebug; \
	echo "xdebug.file_link_format=\"phpstorm://open?file=%f&line=%l&/srv/app/>$PROJECT_HOME_DIR\"" >> /usr/local/etc/php/conf.d/docker-php-ext-xdebug.ini; \
	apk del .build-deps
